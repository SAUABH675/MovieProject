...
const TvDetails= ()=>{
    ...
    if (!info || !info.detail) return <div className="text-white"><Loading/></div>;
    return info?(
        <div 
        style={{
      ...
      <div className="w-[100%]  flex  overflow-y-hidden mb-5 p-5">
        {info.detail.seasons.length > 0 ? (
          info.detail.seasons.map((s, i) => (
            <a
              href={`https://www.themoviedb.org/tv/${id}/season/${s.season_number}`}
              key={i}
              className="w-[15vh] mr-[1%]"
            >
              <img
                className="shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)] h-[30vh] w-[15vw] object-cover"
